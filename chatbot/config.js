  ...
  therapy: {
    ...
    services: {
      ...
      aquatic: {
        ...
        details: [
          "Please be advised that Aquatic Therapy is exclusively available only at our Stafford location.",
        ],
      },
  ...
  rehab: {
    ...
    services: {
      ...
      cupping: {
        ...
        icon: "🔄",
        description:
          "Cupping Therapy is a healing technique that uses special cups to create suction on the skin, drawing blood to the surface and promoting deep tissue healing. This therapy is highly effective for reducing muscle tension, improving circulation, and enhancing recovery while releasing toxins from the body.",
        // details: [
      ...
      paraffin: {
        ...
        icon: "🔥",
        description:
          "Paraffin Wax Therapy is a luxurious heat treatment that involves dipping the hands, feet, or other body parts into warm, soothing wax. This therapy provides deep, penetrating heat that helps improve circulation, relieve joint pain, and intensely moisturize and soften the skin.",
        // details: [
      ...
      normatec: {
        ...
        icon: "🦿",
        description:
          "NormaTec Compression Therapy uses advanced pneumatic compression technology to enhance recovery and performance. This innovative system applies sequential pulse compression to your limbs, effectively flushing out metabolic waste and reducing muscle soreness while improving circulation.",
        // details: [
...
export const SPELLING_CORRECTIONS = {
  ...
  // Services related variations - Refactored to Array
  service: [
    "service",
    "services",
    "servis",
